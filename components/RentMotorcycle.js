  ...
  return (
   ...
   className="">
        ...
        <ScrollView className="space-y-5 ">
          ...
          <View className="p-4 mt-5">
              <TextInput label="name" placeholder="Description" value={description} maxLength={70} onChangeText={(e) => setDescription(e)}   className="bg-\transparent flex-auto mr-3 underline-offset-1 border-b-2 border-[#D4DCF8]" />
          </View>
