        ...
        <View className="flex-col mt-12 space-y-7">
                ...
                <View className="flex-row space-x-2 p-4 justify-between bg-[#dfdfdf] rounded-full">
                    <View className="flex-row space-x-2">
                        ...
                        <Text>Rent your motorcycle</Text>
                    </View>
                    <TouchableOpacity onPress={() => navigate.navigate("RentMotorcycle")}>
                        <Animatable.View 
                        animation={"pulse"}
                        easing={'ease-in-out'}
                        className="">
                ...
                <View className="flex-row space-x-2 p-4 justify-between bg-[#dfdfdf] rounded-full">
                    ...
                    <TouchableOpacity onPress={() => navigate.navigate('MotorcycleBookings', {name: 'MotorcycleBookings'})}>
                        <Animatable.View 
                        animation={"pulse"}
                        easing={'ease-in-out'}
                        className="">
...
export default MotorcycleSettings