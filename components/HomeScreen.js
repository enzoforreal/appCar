  ...
  return (
    <SafeAreaView className="flex-1 relative " >
        <View className="flex-1 relative ">
            ...
            <View className="flex-row  ml-1/2 bottom-[200px] items-center justify-center">
                <Text className="text-white">Get a great car at a great </Text>
                <Text className="text-white underline decoration-[#E1F4CB] ">price</Text>
            </View>
